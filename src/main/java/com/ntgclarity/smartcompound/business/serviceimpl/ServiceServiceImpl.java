...
public class ServiceServiceImpl implements ServiceService {
	...
	@Override
	public com.ntgclarity.smartcompound.common.entity.Service updateService(com.ntgclarity.smartcompound.common.entity.Service service) {
		return serviceDAO.updateService(service);
		
	}

	@Override
	public List<com.ntgclarity.smartcompound.common.entity.Service> loadServices(int first, int pageSize,
